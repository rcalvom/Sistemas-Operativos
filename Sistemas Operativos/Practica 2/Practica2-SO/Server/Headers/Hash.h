...
long buscarId(struct HashTable *table, char *nombre);                       // Busca los elementos que correspondan con el nombre y los devuelve en una lista encadenada
...
void Vaciar();                                                              // Elimina todos los registros en la tabla
